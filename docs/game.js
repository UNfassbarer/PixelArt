...
import { Settings, getRandomInt } from "./script.js";
...
// Right arrow OR D
const GoRight = () => keys[AssignmentKeys.GoRight[0]] || keys[AssignmentKeys.GoRight[1]];
// Left arrow OR A
const GoLeft = () => keys[AssignmentKeys.GoLeft[0]] || keys[AssignmentKeys.GoLeft[1]];
// Top arrow OR Space
const Jump = () => (keys[AssignmentKeys.Jump[0]] || keys[AssignmentKeys.Jump[1]]) && player.onGround;
...
export function StartAnimation(StartTime, action) {
